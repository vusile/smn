    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8" >
                ...
                @endif
                <form method="post" action="/save-mtoa-ithibati" id="mtoa-ithibati-form">
                    <div class="form-group">
                        <p>Jina la wimbo: {{$song->name}}</p>

                        @if($mtoaIthibati)
                            <p>Mtoa Ithibati wa Sasa: {{$mtoaIthibati->name}}</p>
                        @endif
                    </div>

                    <div class="form-group row">
                        <div class="col-sm-8">
                            <p><strong>Chagua mtoa ithibati mpya:</a></strong></p>
                            {{Form::select(
                                  'user_id',
                                  ['' => 'Chagua moja'] + $users,
                                  '',
