                ...
                <div class="container">
                    <form method="post" action="/admin/dominikas/change-status/{{$dominika->id}}">
                        ...
                        @foreach($approvedDominikaSongs->whereIn('id', $mwanzo) as $song)
                            <input id="mwanzo-{{$song->id}}" type="checkbox" name="changeStatus[]" value="{{$song->id}}"> {!! songLink($song) !!} - {{$song->composer->name}} >>
                            @if($statuses[$song->id])
                    ...
                    <form method="post" action="/admin/dominikas/change-status/{{$dominika->id}}">
                        ...
                        @foreach($approvedDominikaSongs->whereIn('id', $katikati) as $song)
                            <input id="katikati-{{$song->id}}" type="checkbox" name="changeStatus[]" value="{{$song->id}}"> {!! songLink($song) !!}  - {{$song->composer->name}} >>
                            @if($statuses[$song->id])
                                <a href = "/admin/review-dominika/deny/{{$song->id}}/{{$dominika->id}}">SI SAWA</a><br />
                            @else
                                <a href = "/admin/review-dominika/approve/{{$song->id}}/{{$dominika->id}}">SAWA</a> ---- <a href = "/admin/review-dominika/deny/{{$song->id}}/{{$dominika->id}}">SI SAWA</a><br />
                    ...
                    <form method="post" action="/admin/dominikas/change-status/{{$dominika->id}}">
                        ...
                        @foreach($approvedDominikaSongs->whereIn('id', $shangilio) as $song)
                            <input id="shangilio-{{$song->id}}" type="checkbox" name="changeStatus[]" value="{{$song->id}}"> {!! songLink($song) !!} - {{$song->composer->name}} >>
                            @if($statuses[$song->id])
                                <a href = "/admin/review-dominika/deny/{{$song->id}}/{{$dominika->id}}">SI SAWA</a><br />
                            @else
                                <a href = "/admin/review-dominika/approve/{{$song->id}}/{{$dominika->id}}">SAWA</a> ---- <a href = "/admin/review-dominika/deny/{{$song->id}}/{{$dominika->id}}">SI SAWA</a><br />
                    ...
                    <form method="post" action="/admin/dominikas/change-status/{{$dominika->id}}">
                        ...
                        @foreach($approvedDominikaSongs->whereIn('id', $antifona) as $song)
                            <input type="checkbox" name="changeStatus[]" value="{{$song->id}}"> {!! songLink($song) !!} - {{$song->composer->name}} >>
                            @if($statuses[$song->id])
                                <a href = "/admin/review-dominika/deny/{{$song->id}}/{{$dominika->id}}">SI SAWA</a><br />
                            @else
                                <a href = "/admin/review-dominika/approve/{{$song->id}}/{{$dominika->id}}">SAWA</a> ---- <a href = "/admin/review-dominika/deny/{{$song->id}}/{{$dominika->id}}">SI SAWA</a><br />
